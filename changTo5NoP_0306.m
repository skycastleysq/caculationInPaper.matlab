...
% 0405_1 有0.06 无0.01以下差距过小不是很好
% x1L=[20,800 ,0.60;25,750 ,0.55;20,800 ,0.60;0 ,  0 ,   0;25,850 ,0.65;0 ,  0 ,   0;0 ,0   ,   0;];
% x1U=[35,1500,0.75;40,1500,0.75;35,1400,0.80;0 ,  0 ,   0;45,1600,0.75;0 ,  0 ,   0;0 ,0   ,   0;];
% x2L=[25,700 ,0.60;15,800 ,0.55;20,700 ,0.70;20,600 ,0.70;30,700 ,0.60;0 ,  0 ,   0;20,750 ,0.65;];
% x2U=[40,1400,0.80;40,1600,0.70;35,1400,0.80;40,1400,0.85;45,1400,0.75;0 ,  0 ,   0;35,1500,0.75;];
% x3L=[25,800 ,0.65;0 ,  0 ,   0;20,750 ,0.70;20,750 ,0.70;0 ,  0 ,   0;25,650 ,0.65;25,700 ,0.60;];
% x3U=[30,1500,0.75;0 ,  0 ,   0;35,1600,0.80;35,1500,0.85;0 ,  0 ,   0;45,1500,0.70;50,1400,0.70;];
% x4L=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;20,700 ,0.60;15,800 ,0.65;25,700 ,0.65;25,650 ,0.65;];
% x4U=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;45,1500,0.80;35,1600,0.80;40,1500,0.70;45,1500,0.80;];
%0405_2 有0.07 无0.02勉强可以
% x1L=[20,800 ,0.60;27,750 ,0.60;20,800 ,0.70;0 ,  0 ,   0;25,850 ,0.65;0 ,  0 ,   0;0 ,0   ,   0;];
% x1U=[35,1500,0.80;37,1500,0.75;40,1400,0.85;0 ,  0 ,   0;45,1600,0.80;0 ,  0 ,   0;0 ,0   ,   0;];
% x2L=[25,700 ,0.70;20,800 ,0.60;20,700 ,0.70;20,600 ,0.70;30,500 ,0.60;0 ,  0 ,   0;25,800 ,0.55;];
% x2U=[40,1400,0.80;35,1600,0.70;35,1400,0.85;40,1300,0.80;45,1300,0.75;0 ,  0 ,   0;50,1600,0.65;];
% x3L=[15,800 ,0.65;0 ,  0 ,   0;20,750 ,0.65;20,700 ,0.70;0 ,  0 ,   0;25,650 ,0.70;25,750 ,0.60;];
% x3U=[30,1500,0.80;0 ,  0 ,   0;35,1500,0.80;35,1400,0.85;0 ,  0 ,   0;40,1600,0.80;50,1400,0.70;];
% x4L=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;20,650 ,0.60;15,800 ,0.70;25,700 ,0.60;25,600 ,0.65;];
% x4U=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;45,1300,0.80;35,1600,0.85;40,1500,0.70;45,1400,0.80;];

%0405_3 有0.07 无0.03勉强可以
...
% x1L=[20,800 ,0.60;25,800 ,0.60;20,800 ,0.70;0 ,  0 ,   0;25,800 ,0.65;0 ,  0 ,   0;0 ,0   ,   0;];
% x1U=[35,1500,0.80;35,1600,0.75;40,1400,0.85;0 ,  0 ,   0;40,1600,0.80;0 ,  0 ,   0;0 ,0   ,   0;];
% x2L=[20,750 ,0.70;15,600 ,0.60;20,700 ,0.70;20,600 ,0.70;25,500 ,0.70;0 ,  0 ,   0;20,750 ,0.65;];
% x2U=[40,1400,0.80;35,1500,0.70;35,1400,0.85;40,1300,0.80;45,1300,0.80;0 ,  0 ,   0;35,1500,0.75;];
% x3L=[15,800 ,0.65;0 ,  0 ,   0;20,750 ,0.70;20,700 ,0.70;0 ,  0 ,   0;25,650 ,0.70;20,750 ,0.60;];
% x3U=[30,1600,0.75;0 ,  0 ,   0;35,1600,0.80;35,1400,0.85;0 ,  0 ,   0;40,1600,0.80;40,1400,0.70;];
% x4L=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;20,650 ,0.60;15,700 ,0.70;25,700 ,0.60;15,600 ,0.65;];
% x4U=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;45,1300,0.80;35,1500,0.85;40,1500,0.70;40,1400,0.80;];
...
% 不行不行不行不行不行 原倒数第2 不行
% x1L=[20,800 ,0.60;25,750 ,0.60;20,800 ,0.70;0 ,  0 ,   0;25,850 ,0.65;0 ,  0 ,   0;0 ,0   ,   0;];
% x1U=[35,1500,0.80;35,1500,0.75;40,1400,0.85;0 ,  0 ,   0;45,1600,0.80;0 ,  0 ,   0;0 ,0   ,   0;];
% x2L=[25,700 ,0.70;15,800 ,0.60;20,700 ,0.70;20,600 ,0.70;30,500 ,0.60;0 ,  0 ,   0;20,750 ,0.65;];
% x2U=[40,1400,0.80;35,1600,0.70;35,1400,0.85;40,1300,0.80;45,1300,0.75;0 ,  0 ,   0;35,1500,0.75;];
% x3L=[15,800 ,0.65;0 ,  0 ,   0;20,750 ,0.65;20,700 ,0.70;0 ,  0 ,   0;15,900 ,0.60;25,950 ,0.55;];
% x3U=[30,1600,0.75;0 ,  0 ,   0;35,1500,0.80;35,1400,0.85;0 ,  0 ,   0;35,1600,0.70;50,1700,0.65;];
% x4L=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;20,650 ,0.55;15,550 ,0.70;25,850 ,0.50;25,950 ,0.55;];
% x4U=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;45,1300,0.70;35,1200,0.85;50,1600,0.65;45,1800,0.70;];

% x1L=[20,800 ,0.60;25,700 ,0.60;20,800 ,0.70;0 ,  0 ,   0;25,800 ,0.65;0 ,  0 ,   0;0 ,0   ,   0;];
...
x3L=[15,750 ,0.65;0 ,  0 ,   0;20,600 ,0.70;15,500 ,0.70;0 ,  0 ,   0;15,500 ,0.75;15,500 ,0.70;];
...
% x1L=[20,800 ,0.60;25,700 ,0.60;20,800 ,0.70;0 ,  0 ,   0;25,800 ,0.65;0 ,  0 ,   0;0 ,0   ,   0;];
% x1U=[35,1500,0.80;40,1600,0.75;40,1500,0.85;0 ,  0 ,   0;45,1700,0.70;0 ,  0 ,   0;0 ,0   ,   0;];
% x2L=[25,700 ,0.70;20,500 ,0.60;20,700 ,0.70;20,500 ,0.70;20,900 ,0.60;0 ,  0 ,   0;15,650 ,0.70;];
% x2U=[40,1400,0.80;35,1400,0.70;35,1400,0.85;35,1300,0.85;45,1800,0.70;0 ,  0 ,   0;30,1350,0.85;];
% x3L=[15,850 ,0.65;0 ,  0 ,   0;20,700 ,0.70;20,600 ,0.65;0 ,  0 ,   0;25,500 ,0.75;15,600 ,0.65;];
% x3U=[30,1600,0.75;0 ,  0 ,   0;35,1400,0.80;40,1400,0.80;0 ,  0 ,   0;35,1400,0.85;30,1350,0.80;];
% x4L=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;20,700 ,0.65;15,700 ,0.55;20,700 ,0.70;15,600 ,0.70;];
% x4U=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;35,1500,0.80;35,1600,0.70;30,1600,0.80;35,1300,0.85;];
%% 规范化
z_sum=zeros(1,12);
% disp('z_sum');disp(z_sum);
% z_j_t
for j=1:7
...
% end
% 
% % disp('r5_RfnL');disp(r5_RfnL);disp('r5_RfnU');disp(r5_RfnU);
% RfpL=[r1_RfpL;r2_RfpL;r3_RfpL;r4_RfpL;];RfpU=[r1_RfpU;r2_RfpU;r3_RfpU;r4_RfpU;];
% RfnL=[r1_RfnL;r2_RfnL;r3_RfnL;r4_RfnL;];RfnU=[r1_RfnU;r2_RfnU;r3_RfnU;r4_RfnU;];
...
% 求灰色关联度
minP=[100,120,120,120];maxP=zeros(1,4);
for k=1:4
    for i=1:7
        for j=1:3
            if(RL(i,j,k)~=0)
...
minN=[120,120,120,120];maxN=zeros(1,4);
for k=1:4
    for i=1:7
        for j=1:3
            if(RL(i,j,k)~=0)
...
kesy_p=cat(3,zeros(7,3),zeros(7,3),zeros(7,3),zeros(7,3));
kesy_n=cat(3,zeros(7,3),zeros(7,3),zeros(7,3),zeros(7,3));
for k=1:4
    for i=1:7
        for j=1:3
            if(RL(i,j,k)~=0)
...
% ub=[0.45;0.40;0.40];
x1_0=[0.3,0.3,0.4];
[x1,fval1]=fmincon(@(x1)attributeWeight_expertNoP(v1p,v1n,x1,1),x1_0,[],[],Aeq1,beq1,lb,ub);
...
[x2,fval2]=fmincon(@(x2)attributeWeight_expertNoP(v2p,v2n,x2,2),x2_0,[],[],Aeq2,beq2,lb2,ub2);
...
[x3,fval3]=fmincon(@(x3)attributeWeight_expertNoP(v3p,v3n,x3,3),x3_0,[],[],Aeq3,beq3,lb3,ub3);
disp('最优解x3');disp(x3);
...
% ub4=[0.45;0.45;0.45];
x4_0=[0.3,0.3,0.4];
%[x4,fval4]=fmincon(@(x4)attributeWeight(v4p_tmp,v4n_tmp,x4),x4_0,[],[],Aeq
%4,beq4,lb4,ub4);
[x4,fval4]=fmincon(@(x4)attributeWeight_expertNoP(v4p,v4n,x4,4),x4_0,[],[],Aeq4,beq4,lb4,ub4);
disp('最优解x4');disp(x4);
...
[rou,fval]=fmincon(@(rou)expertWeight3change(U,rou),x0,[],[],Aeq,beq,lb,ub);
