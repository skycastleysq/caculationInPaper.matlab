 function [sum , paixuf]=five_ProsTheroyAndVariety(x1L,x1U,x2L,x2U,x3L,x3U,x4L,x4U,x5L,x5U)
% clc;clearvars;
format short;
lamda=2.25;
afa=0.88;
...
% x4L=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;20,650 ,0.55;15,550
% ,0.70;25,700 ,0.50;25,950 ,0.55;];
