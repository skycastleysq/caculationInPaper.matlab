function [sum , paixuf]=eight_Pros_Ini_Common(x1L,x1U,x2L,x2U,x3L,x3U,x4L,x4U,x5L,x5U,x6L,x6U,x7L,x7U,x8L,x8U)
%clc;clearvars;
format short;
lamda=2.25;
afa=0.88;
...
% x3L=[15,750 ,0.65;0 ,  0 ,   0;20,600 ,0.70;15,500 ,0.70;0 ,  0 ,   0;15,500 ,0.70;15,500 ,0.70;];
...
% x4U=[0 ,  0 ,   0;0 ,  0 ,   0;0 ,  0 ,   0;30,1600,0.85;35,1400,0.85;30,1300,0.85;35,1300,0.85;];
% 
